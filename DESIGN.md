...
- 中文优先，英文术语只保留必要机制名，例如 `Agent Loop`。
- 每段文案先回答“这是什么、现在能做什么、下一步是什么”。
- 用短句。标题不超过 24 个汉字；摘要尽量不超过 42 个汉字。
- 避免 AI 味和营销腔：赋能、打造、沉淀、范式、生态、底座、抓手、心智、信息熵。
- 避免空泛判断，例如“更智能、更高效、更强大”。改成具体文件、命令、节点或结果。
- 长文优先用 serif 字体
